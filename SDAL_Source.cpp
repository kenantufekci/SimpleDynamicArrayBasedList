...
SCENARIO("SDAL - item at test and [] overloaded function properly", "[Prove item at returns correct number for al positions]"){
	cop3530::SDAL<int> list;	//Initialize the list
...
TEST_CASE("SDAL - push_back/push_front 100 elements", "Prove list size is 1000 and all element in correct location"){
	//This is for list1 that have 1000 elements from 0-999
	cop3530::SDAL<int> list1;	//Initialize the list1
	int i = 0;
	...
	cop3530::SDAL<int> list2;	//Initialize the list1
...
TEST_CASE("SDAL - test overloaded operator[]", "Prove the correct value is returned"){
	cop3530::SDAL<int> list;	//Initialize the list
...
TEST_CASE("SDAL - resize the list", "Prove that the list shrinks"){
	int i = 0;
	cop3530::SDAL<int> list; //Initialize the list
...
TEST_CASE("SDAL - returned values check", "Prove that the functions are returning correct elements"){
	cop3530::SDAL<int> list;	//Initialize the list
	//This is for list2 that have 1000 elements from 0-999
	for (int i = 0; i < 1000; ++i){
		list.push_back(i);
...
TEST_CASE("SDAL - replace function check", "Prove that the elements are being replaces"){
	cop3530::SDAL<int> list; //Initialize the list
...
TEST_CASE("SDAL - insert function check", "Prove that the elements are being inserted into the list"){
	cop3530::SDAL<int> list;	//Initialize the list
...
TEST_CASE("SDAL - remove function check", "Prove that the elements are being remove into the list"){
	cop3530::SDAL<int> list;	//Initialize the list
	for (int i = 0; i < 200; ++i){	//Populate the list with 200 elements
		list.push_back(i);
	}
...
TEST_CASE("SDAL - contains function check", "Prove an element in contained in the list"){
	cop3530::SDAL<int> list;	//Initialize the list
...
TEST_CASE("SDAL - iterator check", "Prove all the element of the iterator is working"){
	cop3530::CDAL<int> list1;	//Initialize the list
	for (int i = 0; i < 2000; ++i) {	//Populate the list with 2000 elements
		list1.push_back(i);
	}

	//Use the copy constructor to set list1 = list2
	const cop3530::CDAL<int> list2 = list1;

	//This is the calling the constructor for iterators
	cop3530::CDAL<int>::iterator iter1 = list1.begin();
	cop3530::CDAL<int>::iterator iter1_1 = list1.begin();
	cop3530::CDAL<int>::const_iterator iter2 = list2.begin();
	cop3530::CDAL<int>::const_iterator iter2_1 = list2.begin();
	...
	for (cop3530::CDAL<int>::const_iterator const_iter = list2.begin(); const_iter != list2.end(); ++const_iter) {
...
TEST_CASE("SDAL - test for exceptions", "Prove that all the exceptions are thrown for invalid operations"){
